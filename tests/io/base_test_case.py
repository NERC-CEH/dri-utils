...
class BaseTestCase(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.s3_client.create_bucket(
            Bucket=cls.bucket_name, CreateBucketConfiguration={"LocationConstraint": "eu-west-2"}
        )

        # Create a test empty bucket
        cls.s3_client.create_bucket(
            Bucket=cls.empty_bucket_name, CreateBucketConfiguration={"LocationConstraint": "eu-west-2"}
        )
    ...
    @classmethod
    def create_and_upload_test_data(cls) -> None:
