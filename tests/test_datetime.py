...
from driutils.datetime import chunk_date_range, steralize_date_range, validate_iso8601_duration
...
class TestValidateISO8601Duration:
    def test_valid_duration_full_format(self) -> None:
        ...
        assert validate_iso8601_duration(duration)
    ...
    def test_invalid_duration_missing_p(self) -> None:
        ...
        assert not validate_iso8601_duration(duration)
...
class TestChunkDateRange:
    ...
    def test_only_one_chunk(self) -> None:
    ...
    def test_multiple_chunks_year(self) -> None:
        ...
        result = chunk_date_range(start_date, end_date, chunk)
        expected = [
            (datetime(2010, 5, 5, 0, 0, 0), datetime(2011, 5, 5, 0, 0, 0)),
    ...
    def test_multiple_chunks_monthly(self) -> None:
        """Test that correct chunks generated."""
        start_date = datetime(2010, 5, 5, 0, 0, 0)
        ...
        result = chunk_date_range(start_date, end_date, chunk)
        expected = [
            (datetime(2010, 5, 5, 0, 0, 0), datetime(2010, 6, 5, 0, 0, 0)),
