...
class TestMetadataApiManager:
    ...
    def test_make_api_call_success(self, api: MetadataAPIManager) -> None:
        ...
        with patch("driutils.metadata_api.api_manager.MetadataAPIManager.make_api_call") as mock_get:
            ...
            assert result.json() == self.mock_response_data
    ...
    def test_make_api_call_404_error(self, api: MetadataAPIManager) -> None:
    ...
    def test_make_api_call_timeout_error(self, api: MetadataAPIManager) -> None:
    ...
    def test_make_api_call_invalid_json(self, api: MetadataAPIManager) -> None:
